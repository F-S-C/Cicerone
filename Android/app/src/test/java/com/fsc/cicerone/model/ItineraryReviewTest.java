...
public class ItineraryReviewTest {
    ...
    public void loadFromJSONObject() throws JSONException {
        ...
        final int feedback = jsonObject.getJSONObject("feedback").getInt("feedback");
        final String description = jsonObject.getJSONObject("description").getString("description");
    ...
    public void toJSONObject() throws JSONException {
        ...
        assertEquals("Fields didn't match", itineraryReview.toJSONObject().toString(), jsonObject.toString());
