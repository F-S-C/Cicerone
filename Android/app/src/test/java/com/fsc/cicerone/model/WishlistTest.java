...
public class WishlistTest {
    ...
    public void loadFromJSONObject() throws JSONException {
        ...
        final Wishlist wishlist = new Wishlist(jsonObject.toString());

        final String TAG = "Fields not setted properly";
        assertEquals(TAG, wishlist.getUser(), new User(jsonObject.getString("username")));
        assertEquals(TAG, wishlist.getItinerary(), new Itinerary(jsonObject.getString("itinerary_in_wishlist")));
    }
    ...
    public void toJSONObject() throws JSONException {
        ...
        Wishlist wishlist = new Wishlist(jsonObject.toString());
        Map<String, Object> obj = wishlist.toMap();

        assertEquals("Fields didn't match", new User((String) obj.get("username")), new User(jsonObject.getString("username")));
        assertEquals("Fields didn't match", new Itinerary((String) obj.get("itinerary_in_wishlist")), new Itinerary(jsonObject.getString("itinerary_in_wishlist")));
    }
}